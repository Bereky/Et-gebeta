...
void Main_srv:: main_menu(){
    ...
    switch(input){
        case '1': choose(); break;
        case '2': other_service(); break;
        case '3': change_lang(); break;
        case '4': my_account(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
}
void Main_srv:: pkg_service(){
    ...
    cin>>input;
    switch(input){
        case '1': pckg.voice_pkg(); break;
        case '2': pckg.internet_pkg(); break;
        case '3': pckg.voice_plus_pkg(); break;
        case '4': pckg.flexi_pkg(); break;
        case '5': pckg.premium_pkg(); break;
        case '6': pckg.long_term_pkg(); break;
        case '7': pckg.inter_call_pkg(); break;
        case '8': pckg.morning_pkg(); break;
        case '9': pckg.sms_pkg(); break;
        case '*': service.choose(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }    
}
...
void Main_srv:: choose(){
    ...
    switch(input){
        case '1': pkg_service(); break;
        case '2': pkg_service();  break;
        case '*': main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
}
...
void Main_srv:: confirm(){
    ...
    cout<<"\n\t1.Confirm";
    cout<<"\n\t  Other key to canc    el";
    cout <<"\n\nEnter your choice: ";
    cin>>input;
    switch(input){
        case '1': success(); break;
        default : "\nProcess Canceled"; break;
        }      
    }
    else{
...
void Main_srv:: confirm_no(){
    ...
    switch(input){
        case '1': success(); break;
        case '*': service.receiver_number(); break;
        default : "\nProcess Canceled"; break;
    }
...
void Pkg_srv:: voice_pkg(){
    ...
    cin>>input;
    switch(input){
        case '1': voice.daily_voice(); break;
        case '2': voice.weekly_voice(); break;
        case '3': voice.monthly_voice(); break;
        case '4': voice.night_voice(); break;
        case '*': service.choose(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
}
void Pkg_srv:: internet_pkg(){
    ...
    cin>>input;
    switch(input){
        case '1': internet.daily_int(); break;
        case '2': internet.weekly_int(); break;
        case '3': internet.monthly_int(); break;
        case '4': internet.night_int(); break;
        case '*': service.choose(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void Pkg_srv:: voice_plus_pkg(){
    ...
    cin>>input;
    switch(input){
        case '1': voice_plus.daily_srv(); break;
        case '2': voice_plus.weekly_srv(); break;
        case '3': voice_plus.monthly_srv(); break;   
        case '*': service.choose(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void Pkg_srv:: flexi_pkg(){
    ...
    cin>>input;
    switch(input){
        case '1': flexi.daily_flexi(); break;
        case '2': flexi.weekly_flexi(); break;
        case '3': flexi.monthly_flexi(); break;
        case '*': service.choose(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void Pkg_srv:: premium_pkg(){
    ...
    cin>>input;
    switch(input){
        case '1': prem.monthly_premium(); break;        
        case '*': service.choose(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void Pkg_srv:: long_term_pkg(){
    ...
    cin>>input;
    switch(input){
        case '1': long_term.quarterly(); break;
        case '2': long_term.yearly(); break;        
        case '*': service.choose(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void Pkg_srv:: inter_call_pkg(){
    ...
    cin>>input;
    switch(input){
        case '1': inter_call.weekly_call(); break;
        case '2': inter_call.bi_weekly_call(); break;
        case '3': inter_call.monthly_call(); break;        
        case '*': service.choose(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void Pkg_srv:: morning_pkg(){
    ...
    cin>>input;
    switch(input){
        case '1': req=2; morning.morn_1(); break;
        case '2': req=2; morning.morn_2(); break;        
        case '*': service.choose(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void Pkg_srv:: sms_pkg(){
    ...
    cin>>input;
    switch(input){
        case '1': sms.daily_sms(); break;
        case '2': sms.weekly_sms(); break;   
        case '3': sms.monthly_sms(); break;     
        case '*': service.choose(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void Voice_srv:: daily_voice(){
    ...
    cin>>input;
    switch(input){
        case '1': req=3;  service.confirm(); break;
        case '2': req=5; service.confirm(); break;  
        case '3': req=10;  service.confirm(); break;      
        case '*': pckg.voice_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
}
void Voice_srv:: weekly_voice(){
    ...
    cin>>input;
    switch(input){
        case '1': req=15;  service.confirm(); break;
        case '2': req=20;  service.confirm(); break;
        case '3': req=25; service.confirm(); break;        
        case '*': pckg.voice_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void Voice_srv:: monthly_voice(){
    ...
    cin>>input;
    switch(input){
        case '1': req=35;  service.confirm(); break;
        case '2': req=50;  service.confirm(); break;   
        case '3': req=95;  service.confirm(); break;
        case '4': req=120;  service.confirm(); break;        
        case '5': req=200; service.confirm(); break;
        case '6': req=380;  service.confirm(); break;    
        case '*': pckg.voice_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void Voice_srv:: night_voice(){
    ...
    switch(input){
        case '1': req=3;  service.confirm(); break;
        case '2': req=6;  service.confirm(); break;     
        case '*': pckg.voice_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void Internet_srv:: daily_int(){
    ...
    switch(input){
        case '1': req=3;  service.confirm(); break;
        case '2': req=5; service.confirm(); break;
        case '3': req=12;  service.confirm(); break;
        case '4': req=25; service.confirm(); break;        
        case '*': pckg.internet_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
}
void Internet_srv:: weekly_int(){
    ...
    cin>>input;
    switch(input){
        case '1': req=24;  service.confirm(); break;
        case '2': req=35;  service.confirm(); break;
        case '3': req=56;  service.confirm(); break;        
        case '*': pckg.internet_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void Internet_srv:: monthly_int(){
    ...
    switch(input){
        case '1': req=35;  service.confirm(); break;
        case '2': req=60;  service.confirm(); break;
        case '3': req=105;  service.confirm(); break;
        case '4': req=200; service.confirm(); break;
        case '5': req=420; service.confirm(); break;        
        case '*': pckg.internet_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void Voice_plus_srv:: daily_srv(){
    ...
    cin>>input;
    switch(input){
        case '1': req=12; service.confirm(); break;
        case '2': req=35;  service.confirm(); break;      
        case '*': pckg.voice_plus_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
}
void Voice_plus_srv:: weekly_srv(){
    ...
    cin>>input;
    switch(input){
        case '1': req=50;  service.confirm(); break;
        case '2': req=76; service.confirm(); break;      
        case '*': pckg.voice_plus_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void Voice_plus_srv:: monthly_srv(){
    ...
    cin>>input;
    switch(input){
        case '1': req=140; service.confirm(); break;
        case '2': req=200; service.confirm(); break;    
        case '3': req=1663; service.confirm(); break;  
        case '*': pckg.voice_plus_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void Flexi_srv:: monthly_flexi(){
    ...
    cin>>input;
    switch(input){
        case '1': req=100;  service.confirm(); break;     
        case '*': pckg.flexi_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void Premium_srv:: monthly_premium(){
    ...
    cin>>input;
    switch(input){
        case '1': req=1510;  service.confirm(); break;
        case '2': req=1510; service.confirm(); break; 
        case '3': req=2545;  service.confirm(); break;     
        case '*': pckg.premium_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
}
...
void Long_term_srv:: quarterly(){
    ...
    cin>>input;
    switch(input){
        case '1': req=825; service.confirm(); break;
        case '2': req=1095;  service.confirm(); break;    
        case '3': req=4227; service.confirm(); break;
        case '4': req=5205; service.confirm(); break;      
        case '5': req=6872;  service.confirm(); break;  
        case '*': pckg.long_term_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
}
void Long_term_srv:: yearly(){
    ...
    cin>>input;
    switch(input){
        case '1': req=18324; service.confirm(); break;
        case '2': req=10872; service.confirm(); break;    
        case '3': req=10872; service.confirm(); break;  
        case '*': pckg.long_term_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void Inter_call_srv:: weekly_call(){
    ...
    cin>>input;
    switch(input){
        case '1': req=59; service.confirm(); break;  
        case '*': pckg.inter_call_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
}
...
void Inter_call_srv:: monthly_call(){
    ...
    cin>>input;
    switch(input){
        case '1': req=195; service.confirm(); break; 
        case '*': pckg.inter_call_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void SMS_srv:: daily_sms(){
    ...
    cin>>input;
    switch(input){
        case '1': req=2;  service.confirm(); break;
        case '2': req=3;  service.confirm(); break;    
        case '3': req=5; service.confirm(); break; 
        case '*': pckg.sms_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
}
void SMS_srv:: weekly_sms(){
    ...
    cin>>input;
    switch(input){
        case '1': req=10;  service.confirm(); break;
        case '2': req=15;  service.confirm(); break;     
        case '*': pckg.sms_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
    }
...
void SMS_srv:: monthly_sms(){
    ...
    cin>>input;
    switch(input){
        case '1': req=30;  service.confirm(); break;
        case '2': req=50;  service.confirm(); break;     
        case '*': pckg.sms_pkg(); break;
        case '#': service.main_menu(); break;
        default: cout<<"\nINVALID INPUT! "; break;
